...
class _ScArtisan2State extends State<ScArtisan2> {
  ...
  final wilayas = ['ولاية أدرار', 'ولاية الشلف', 'ولاية الأغواط', 'ولاية أم البواقي', 'ولاية باتنة', 'ولاية بجاية', 'ولاية بسكرة', 'ولاية بشار', 'ولاية البليدة', 'ولاية البويرة', 'ولاية تمنراست', 'ولاية تبسة', 'ولاية تلمسان', 'ولاية تيارت', 'ولاية تيزي وزو', 'ولاية الجزائر', 'ولاية الجلفة', 'ولاية جيجل', 'ولاية سطيف', 'ولاية سعيدة', 'ولاية سكيكدة', 'ولاية سيدي بلعباس', 'ولاية عنابة', 'ولاية قالمة', 'ولاية قسنطينة', 'ولاية المدية', 'ولاية مستغانم', 'ولاية المسيلة', 'ولاية المغرب', 'ولاية المنيعة', 'ولاية المسيلة', 'ولاية معسكر', 'ولاية نعامة', 'ولاية وهران', 'ولاية البيض', 'ولاية إليزي', 'ولاية برج بوعريريج', 'ولاية بومرداس', 'ولاية الطارف', 'ولاية تندوف', 'ولاية تسمسيلت', 'ولاية الوادي', 'ولاية خنشلة', 'ولاية سوق أهراس', 'ولاية تيبازة', 'ولاية ميلة', 'ولاية عين الدفلى', 'ولاية النعامة', 'ولاية عين تيموشنت', 'ولاية غرداية', 'ولاية غليزان', 'ولاية البيضاء', 'ولاية الأبيار', 'ولاية تامنراست', 'ولاية إيليزي', 'ولاية برج باجي مختار', 'ولاية بومرداس', 'ولاية الشرقية', 'ولاية الغربية', 'ولاية إليزي', 'ولاية اليزي', 'ولاية تندوف', 'ولاية تيسمسيلت', 'ولاية الأغواط', 'ولاية ولاية الأمير عبد القادر', 'ولاية ولاية عين صالح', 'ولاية ولاية البيض', 'ولاية ولاية النعامة', 'ولاية ولاية تندلة', 'ولاية ولاية إليزي', 'ولاية ولاية بومرداس',
  ];
                  ...
                  child: Container(
                    ...
                    decoration: ShapeDecoration(
                      ...
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(screenHeight * 0.034),
                      ),
                    ),
                    child: Center(
                      child: DropdownButton<String>(
                        hint: Align(
                          ...
                          child: Text(
                            selectedWilaya != null ? selectedWilaya : '        الولايـــــــــــة       ',
                            style: TextStyle(
                    ...
                    child: Center(
                      child: DropdownButton<String>(
                        hint: Align(
                          alignment: Alignment.center,
                          child: Text(
                            selectedDaira != null ? selectedDaira : '        الدائــــــــــــــرة       ',
                            style: TextStyle(
                              color: Colors.black38,
                              fontSize: screenHeight * 0.031,
                              fontFamily: 'Lalezar',
                    ...
                    child: Center(
                      child: DropdownButton<String>(
                        hint: Align(
                          alignment: Alignment.center,
                          child: Text(
                            selectedBaladia != null ? selectedBaladia : '        البلــــديـــــــة       ',
                            style: TextStyle(
                              color: Colors.black38,
                              fontSize: screenHeight * 0.031,
                              fontFamily: 'Lalezar',
